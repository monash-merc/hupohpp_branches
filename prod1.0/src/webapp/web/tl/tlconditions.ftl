...
<div class="tl_control_left">
    <div class="filter_field_row">
        <div class="base_conds">
            ...
            <!-- @s.checkbox name="tlSearchBean.paDbSelected" id="selected_dbsource" cssClass="check_box_norm" /> PA &nbsp;&nbsp; -->
    ...
    <div class="advanced_filter_mode" style="display: none;">
        ...
        <div class="filter_field_row">
            ...
            <div class="filter_field_value">From: &nbsp; <@s.textfield name="tlSearchBean.regionFrom" id="tlSearchBeanRegionFrom" cssClass="numberinput" /> &nbsp; To:
