...
<@s.if test="%{#session.authentication_flag =='authenticated'}">
    ...
    <div class="display_middle_div">
        ...
        <div class="display_inner_div">
            ...
            <p>
                TPB is being developed to assist in the chromosome-centric Human Proteome Project (C-HPP). For more information about this global initiative, please visit the <a
            ...
            <div class="doc_sub">
                <ul id="toc">
                    <li>User Guide: download PDF format <a href="${base}/site/ddoc.jspx?fname=UserGuide.pdf">PDF</a></li>
                    <li><a href="${base}/site/dtmapping.jspx">Data Types and Mapping</a> or download PDF format <a href="${base}/site/ddoc.jspx?fname=DataTypesAndMappings.pdf">PDF</a></li>
                </ul>
            </div>
            <div class="blank_separator"></div>
        </div>
