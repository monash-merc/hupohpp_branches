<div class="simple_con_div">
    <div class="simple_conditions">
        <@s.form action="trafficlight.jspx" namespace="/tl" method="post">
            Chromosome: <@s.select name ="tlSearchBean.selectedChromType"  list ="chromTypes"  cssClass="select_norm"/> &nbsp;&nbsp;
            ...
            &nbsp; <@s.checkbox name="tlSearchBean.paDbSelected" cssClass="check_box_norm" />PA &nbsp; &nbsp; &nbsp;
