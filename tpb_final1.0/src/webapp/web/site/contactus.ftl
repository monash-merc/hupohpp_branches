...
<@s.if test="%{#session.authentication_flag =='authenticated'}">
    ...
    <div class="display_middle_div">
        ...
        <@s.if test="%{successActMsg != null}">
            ...
            <p>
                TPB welcomes your suggestions or comments. Using the form below, you can share your news suggestions,
                contact our researchers or developing team. If you have a question about TPB, we may have answered it on
        ...
        <@s.form action="contactus.jspx" namespace="/site" method="post">
            <div class="form_data_div">
                ...
                <div class="field_value_div">
                    <@s.textarea  name="message" cols="70" rows="8" cssClass="input_textarea" /> * (messages
                    required)
                </div>
